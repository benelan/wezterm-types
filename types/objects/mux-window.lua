...
---@field public domain table<string, string>
...
---@field set_title fun(self: MuxWindow, title: string): nil Sets the window title to the provided string. Note that applications may subsequently change the title via escape sequences.
---@field set_workspace fun(self: MuxWindow): nil Changes the name of the workspace to which the window belongs.
---@field spawn_tab fun(self:MuxWindow, params: SpawnTabArgs): MuxTabObj, Pane, MuxWindow  Spawns a program into a new tab within this window, returning the MuxTab, Pane and MuxWindow objects associated with it. When no arguments are passed, the default program is spawned. TODO
