...
---@field username string | nil The username portion of the URL, or an empty string if none is specified
---@field password string | nil The password portion of the URL, or nil if none is specified
