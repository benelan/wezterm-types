...
---@field font (fun(name: string, font_attributes: FontAttributes?): Fonts) | (fun(font_attributes: FontAttributes): Fonts)  https://wezfurlong.org/wezterm/config/lua/wezterm/font.html
